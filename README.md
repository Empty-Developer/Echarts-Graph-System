...
1. **Выбор библиотеки** - Мне нужно было узнать, что за библиотека используется для написания такого графика, и я откинул gemini скрин графика, чтобы она дала мне точный вариант. После чего я попросил её скинуть документацию на график и узнать, как строятся такие графики.
